  ...
  return (
    <div className="container">
      ...
      <div className="card" style={{ marginBottom:16 }}>
        <div style={{ fontSize:18, fontWeight:600 }}>Hi, {user?.name || 'Student'}! Here’s a snapshot of how you’re doing this week.</div>
      </div>
      ...
      <div className="grid cols-3">
        <div className="card" style={{ display:'grid', placeItems:'center' }}>
          ...
          <div className="tooltip" style={{ marginTop:10, textAlign:'center' }}>
            Your score is based on overall digital well-being this week. It’s private and only visible to you and your counselor.
          </div>
        </div>
      ...
      <div style={{ marginTop:16 }} className="grid cols-3">
        <div className="kpi">
          ...
          <div className="value">+4 since last week</div>
        </div>
        <div className="kpi">
          <div className="label">Conversations</div>
          <div className="value">2 this week</div>
        </div>
        <div className="kpi">
          <div className="label">Flags</div>
          <div className="value"><span className="tag">Low</span></div>
        </div>
      </div>
    </div>
  )
